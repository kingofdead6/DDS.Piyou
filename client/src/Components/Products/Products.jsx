  ...
  return (
    <div className="min-h-screen bg-[#d8cfc7] pt-24">
      <div className="max-w-7xl mx-auto px-6 pb-10">
        <h1 className="text-3xl font-medium tracking-wide">Shop All</h1>
      </div>
        ...
        <main className="flex-1">
          <div className="grid grid-cols-3 gap-8">
            {displayedProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition transform hover:-translate-y-1">
