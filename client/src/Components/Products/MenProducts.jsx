  ...
  return (
    <>
      <div className="min-h-screen pt-20 pb-10" dir={isRTL ? "rtl" : "ltr"}>
        ...
        {/* ANIMATED MOBILE FILTER DRAWER - NOW WITH DROPDOWN */}
        {isFilterOpen && (
          <>
            {/* Backdrop */}
            <div
              ...
              >
                ...
                <div className="p-6 pb-10">
                  ...
                  <div className="space-y-10">
                    {/* CATEGORY - NOW A BEAUTIFUL DROPDOWN */}
                    <div>
                    ...
                    <button
                      onClick={clearFilters}
                      className="cursor-pointer w-full py-4 bg-black text-white rounded-xl font-medium hover:bg-gray-900 transition shadow-lg mt-8"
                    >
                      {f.clearAll}
                    </button>
                  </div>
