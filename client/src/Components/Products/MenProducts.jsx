...
export default function MenProductsPage() {
  ...
  const f = translations[lang].filters; // shared filters
  const isRTL = lang === "ar";
              ...
              <div className="flex gap-4 flex-wrap">
                {uniqueColors.map(color => (
                  <button
                    ...
                    className={`cursor-pointer relative w-12 h-12 rounded-full border-4 transition-all shadow-lg
          ...
          {displayedProducts.length === 0 ? (
            <div className="text-center py-32">
              ...
              <button
                ...
                className="cursor-pointer mt-6 text-black underline text-lg"
              >
                {t.viewAll}
              </button>
            </div>
                  ...
                  >
                    ...
                    <div className="p-8 space-y-4">
                      ...
                      <Link
                        ...
                        className="cursor-pointer block text-center mt-6 py-3 border border-black hover:bg-black hover:text-white transition rounded text-sm font-medium"
                      >
                        {t.viewDetails}
                      </Link>
                    </div>
              ...
              {totalPages > 1 && (
                <div className="flex justify-center gap-4 mt-20 flex-wrap">
                  <button
                    ...
                    className="cursor-pointer px-6 py-3 border border-black disabled:opacity-40 hover:bg-black hover:text-white transition rounded"
                  >
                    {f.previous}
                  </button>
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map(n => (
                    <button
                      ...
                      className={`cursor-pointer w-12 h-12 rounded-full text-sm font-medium transition
